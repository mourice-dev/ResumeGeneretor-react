    ...
    <div className="flex-grow flex items-center justify-center p-6 bg-gray-50/50">
      <div className="w-full max-w-[420px]">
        <div className="text-center mb-8">
           <h1 className="text-3xl font-black text-black tracking-tighter mb-2">Welcome back</h1>
           <p className="text-sm text-gray-400 font-medium">Enter your credentials to access your account</p>
        </div>
        ...
        <div className="bg-white p-10 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <div className="mt-8 text-center text-sm text-gray-400">
            No account? <Link to="/register" className="text-black font-bold hover:underline">Create one</Link>
          </div>
        </div>
      </div>
    </div>
